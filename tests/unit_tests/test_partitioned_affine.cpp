...
TEMPLATE_TEST_CASE("PartitionedAffine", "", float, double) {
    ...
    //         //     test_interval(value.traditional_interval(), three,
    //         value_t(6.0));
    //         // }
    ...
    //             // // Sharp answer is [3, 8]
    //             // test_interval(value.range(), 2.9886718, 8.00000);
