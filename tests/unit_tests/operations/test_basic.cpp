...
// TEMPLATE_TEST_CASE("Basic (General Interval)", "", sigma::IFloat,
//                    sigma::IDouble) {
...
//     SECTION("Absolute Value") {
//         SECTION("All positive") {
//             auto a = testing_t(TestType(value_t{1}, value_t{3}));
//             test_interval(sigma::abs(a), 1.0, 3.0);
//             test_interval(sigma::fabs(a), 1.0, 3.0);
//         }
//         SECTION("All negative") {
//             auto a = testing_t(TestType(value_t{-3}, value_t{-1}));
//             test_interval(sigma::abs(a), 1.0, 3.0);
//             test_interval(sigma::fabs(a), 1.0, 3.0);
//         }
//         SECTION("Straddles zero") {
//             auto a = testing_t(TestType(value_t{-2}, value_t{3}));
//             test_interval(sigma::abs(a), 0.0, 3.0);
//             test_interval(sigma::fabs(a), 0.0, 3.0);
//         }
//     }
