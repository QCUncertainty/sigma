...
/** @relates Uncertain
 *  @brief Compare two uncertain variables for equality
 *
 *  @tparam ValueType The numerical type of the variable
...
/** @relates Uncertain
 *  @brief Compare two uncertain variables for inequality
 *
 *  @tparam ValueType The numerical type of the variable
 *  @param lhs The first variable
 *  @param rhs The second variable
...
/** @relates Uncertain
 *  @brief Whether one uncertain variable is less than another
 *
...
/** @relates Uncertain
 *  @brief Whether one uncertain variable is greater than another
 *
 *  Compares the mean values of the two variables
 *
 *  @tparam ValueType The numerical type of the variable
...
/** @relates Uncertain
 *  @brief Whether one uncertain variable is less than or equal to another
 *
 *  @tparam ValueType The numerical type of the variable
 *  @param lhs The first variable
 *  @param rhs The second variable
...
/** @relates Uncertain
 *  @brief Whether one uncertain variable is greater than or equal to another
 *
 *  @tparam ValueType The numerical type of the variable
 *  @param lhs The first variable
 *  @param rhs The second variable
...
#include "sigma/uncertain/eigen_compat.hpp"
#include "sigma/uncertain/operations/operations.hpp"
