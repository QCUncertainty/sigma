...
macro(cxx_api_docs)
    ...
    # Target naming
        ...
        set(HTML_HEADER "${CMAKE_CURRENT_SOURCE_DIR}/docs/header.html")
        set(JS_DARKMODE_TOGGLE "${AWESOME_CSS_DIR}/doxygen-awesome-darkmode-toggle.js")
        set(DOXYGEN_HTML_HEADER "${HTML_HEADER}")
        set(DOXYGEN_HTML_EXTRA_FILES "${JS_DARKMODE_TOGGLE}")
